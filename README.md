...
④ 경기 세트 수의 반 이상을 먼저 승리한 선수가 최종 승자이다.  <br>
...
=> 메서드 : pointWinner (int p) > int p의 값이 1인가 2인가에 따라 해당 선수의 포인트 증가  <br>
         ㄴ 인터페이스 : 게임 스코어 및 세트 스코어 계산 방식 이 메서드에 적용  <br>

2. 게임
6게임 승리시 한세트 획득(6번 이겨야)  <br>
* 듀스 : 5:5 > 어드벤티지룰 : 두 게임 연속으로 이겨야 한 세트 획득   <br>
※ 테이브레이크 : 6:6이 되면 2 게임을 더 얻는 방식 -> 고려 X  <br>

3. 세트 
* 여성 단식/ 복식 / 혼합복식 : 3세트 => 2세트 획득시 매치)  <br>
* 남성 단식/ 복식 : 5세트 => 3세트 획득시 매치)  <br>
